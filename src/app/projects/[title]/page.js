...
const page = () => {
  ...
  return (
    <div className=" h-screen pt-15 lg:h-fit text-white font-inter bg-gradient-to-br from-neutral-950 to-neutral-800">
      {projects.map((project, index) => {
        if (project.title.toLowerCase() === title) {
          return (
            <div key={index}>
              <div
                className=" relative w-full h-[16rem] lg:h-[50rem] bg-cover bg-top after:absolute after:inset-0 after:bg-gradient-to-b after:from-[#11264D] after:via-transparent after:to-transparent before:absolute before:inset-0 before:bg-gradient-to-r before:from-black/50 before:via-transparent before:to-black/50"
                style={{
              ...
              >
                <img
                  ...
                  src={arrow.src}
                  className=" cursor-pointer absolute w-6 h-6 lg:w-8 lg:h-8 top-8 left-8 lg:left-16 z-10 "
                />
              </div>
              <div className=" w-full p-4 lg:p-16 px-16 lg:px-36">
                <div className=" w-full flex justify-between items-center">
                  <h2 className=" text-lg lg:text-2xl text-neutral-400 font-semibold">
                    My Project
                  </h2>
                  <a>
                    <div className=" bg-[#11264D] rounded-2xl p-1 px-4 flex items-center justify-center gap-x-1">
                      <h1 className=" text-lg lg:text-2xl text-white">visit</h1>
                      <img
                        src={linkIcon.src}
                ...
                <h1 className=" mt-8 lg:mt-16 my-4 text-3xl lg:text-5xl font-bold text-white">
                  {project.title}
                </h1>
